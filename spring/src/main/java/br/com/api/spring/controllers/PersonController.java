...
public class PersonController {
	...
	public PersonVO disablePerson(@PathVariable(value = "id") Long id) { 
		return perSer.disablePerson(id); 
	}
	...
	// copia do findAll com alteraçoes
	@GetMapping( value = "findPersonByName/{firstName}", // para não dar ambiguidade de rotas, e com o parametro que será passado
		produces = {MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML}) 
    ...
    public ResponseEntity<PagedModel<EntityModel<PersonVO>>> findPersonByName( 
		@PathVariable(value = "firstName") String firstName, // parametro para pesquisa por nome
		...
		return ResponseEntity.ok(perSer.findPersonByName(firstName, pageable)); 
    }
    ...
    public ResponseEntity<PagedModel<EntityModel<PersonVO>>> findAll( 
        ...
        Pageable pageable = PageRequest.of(page, size, Sort.by(sortDirection, "firstName")); 
		return ResponseEntity.ok(perSer.findAll(pageable)); 
    }
